        ...
        <div id="order_invoice" className="p-3 border border-secondary">
          <header className="clearfix">
            ...
            <div id="company" className="clearfix">
              <div>ShopPlusPlus</div>
              <div>
                455 Foggy Heights,
                <br />
                AZ 85004, US
              </div>
              <div>(689) 624-0368</div>
              <div>
                <a href="mailto:info@shopplusplus.com">info@shopplusplus.com</a>
              </div>
            </div>
            <div id="project">
              <div>
              ...
              <div>
                <span>PAYMENT</span> {paymentInfo?.status}
              </div>
            </div>
          </header>
          <main>
            ...
            <div id="notices">
              ...
              <div className="notice">
                Returns are accepted within 14 days of receipt. Items must be in original condition. For more details, contact support.
              </div>
            </div>
          </main>
